...
- **Animation & FX**: GSAP (GreenSock) + ScrollTrigger
- **Smooth Scroll**: Lenis
...
Visit `http://localhost:5173` to explore the live development build.
...
A GitHub Actions workflow is pre-configured in `.github/workflows/deploy.yml`. Every push to the `main` branch automatically builds and publishes the latest version to GitHub Pages.
...
<div align="center">
  <sub>Engineered by Mahdyar Monfared · 2026</sub>
</div>
